...
class AwsAccountsControllerTest < ActionController::TestCase
  ...
  test "should create aws_account" do
    assert_difference('AwsAccount.count') do
      post :create, aws_account: { access_key: @aws_account.access_key, account_id: @aws_account.account_id, name: @aws_account.name, secret_key: @aws_account.secret_key }
    end
  ...
  test "should update aws_account" do
    patch :update, id: @aws_account, aws_account: { access_key: @aws_account.access_key, account_id: @aws_account.account_id, name: @aws_account.name, secret_key: @aws_account.secret_key }
    assert_redirected_to aws_account_path(assigns(:aws_account))
  end
